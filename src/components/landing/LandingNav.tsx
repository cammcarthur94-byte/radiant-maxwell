    ...
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200/80 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-3 group">
          <div className="w-8 h-8 rounded-xl bg-indigo-600 group-hover:bg-indigo-700 transition-colors flex items-center justify-center font-bold text-white shadow-xs shadow-indigo-500/20 text-sm">
            R
          </div>
          <div>
            ...
            <span className="ml-2 text-[10px] font-bold bg-slate-100 text-slate-700 border border-slate-200 px-2 py-0.5 rounded-full font-mono uppercase tracking-wider">
              AEO &bull; GEO &bull; AIO
            </span>
          </div>
        </Link>
        ...
        <div className="hidden sm:flex items-center space-x-3">
          ...
          <Link
            href="/signup"
            className="inline-flex items-center space-x-1.5 text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 px-4 py-2 rounded-xl transition-all shadow-xs hover:shadow-md hover:shadow-indigo-500/20 active:scale-98"
          >
        ...
        <div className="md:hidden border-b border-slate-200 bg-white px-4 py-5 space-y-4 animate-in fade-in">
          <div className="flex flex-col space-y-3 text-sm font-semibold text-slate-700">
            ...
            <Link
              href="/dashboard"
              onClick={() => setMobileMenuOpen(false)}
              className="text-indigo-600 font-bold flex items-center gap-1.5"
            >
          ...
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            ...
            <Link
              href="/signup"
              className="w-full text-center py-2.5 rounded-xl bg-indigo-600 font-semibold text-xs text-white hover:bg-indigo-700 shadow-xs"
            >
              Start Free
            </Link>
          </div>
