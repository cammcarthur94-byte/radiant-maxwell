...
export default function CitationAnalysisPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 p-6 sm:p-8 space-y-6 max-w-7xl">
      ...
      {/* 2. Middle Section: Volume Area Chart & Type Distribution Donut */}
      ...
      {/* 4. Citation Examples (Quote Cards Feed) */}
      <div className="bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs space-y-4">
        ...
        <div className="space-y-4 pt-1">
          {citationExamples.map((ex) => (
            <div
              key={ex.id}
              className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-2xs space-y-3 hover:border-slate-300 transition-colors"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
